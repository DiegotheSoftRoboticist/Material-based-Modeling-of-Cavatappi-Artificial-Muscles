...
% Retrieve Data Sample 1
    filename = '200grams Sample 1 Test 2.xlsx';
    sheet = 'Sheet1';
...
% Retrieve Data Sample 2
    filename = '200grams Sample 2 Test 1.xlsx';
    sheet = 'Sheet1';
...
% Retrieve Data Sample 3
    filename = '200grams Sample 3 Test 1.xlsx';
    sheet = 'Sheet1';
...
Strain(i) = (Delta(i)/80)*100; %for .2 kg load
...
plot((Pressure_1(24897-20:50:28458-20)-Pressure_1(24897-20))/145.038,-(Strain1(24897:50:28458)-Strain1(24897)),'-','Linewidth',1,'Color',[0 0.4 0.9])
% plot((Pressure_2(20846-50:50:23790-50)-Pressure_2(20846-50))/145.038,-(Strain2(20846:50:23790)-Strain2(20846)),'-.','Linewidth',1.5,'Color',[0.5,0.5,0.5])
plot((Pressure_3(16377-50:50:20673-50)-Pressure_3(16377-50))/145.038,-(Strain3(16377:50:20673)-Strain3(16377)),'-','Linewidth',1,'Color',[0.2 0.8 0.8])
...
grid on 
set(gca,'GridColor',[0.1 0.2 0.9]) % a bluish color 
print(gcf,'CavatappiArtificialMuscle_200grams.png','-dpng','-r700');   



fig=figure('units','inch','position',[0,0,3.6,2.9]); hold on; grid on; set(gca,'FontSize',10);
plot((Pressure_1(24897-20:50:28458-20-2600)-Pressure_1(24897-20))/145.038,-(Strain1(24897:50:28458-2600)-Strain1(24897)),'-','Linewidth',1,'Color',[0 0.4 0.9])
% plot((Pressure_2(20846-50:50:23790-50)-Pressure_2(20846-50))/145.038,-(Strain2(20846:50:23790)-Strain2(20846)),'-.','Linewidth',1.5,'Color',[0.5,0.5,0.5])
plot((Pressure_3(16377-50:50:20673-50-2800)-Pressure_3(16377-50))/145.038,-(Strain3(16377:50:20673-2800)-Strain3(16377)),'-','Linewidth',1,'Color',[0.2 0.8 0.8])
% plot(145.038*PressureFT_2MPa(14587:60:19215)-145.038*PressureFT_2MPa(14587),(-GammaFT_2(14587:60:19215)+GammaFT_2(14587)),':','Linewidth',1.5)
% plot(145.038*PressureFT_2MPa(27467:60:33976)-145.038*PressureFT_2MPa(27467),(-GammaFT_2(27467:60:33976)+GammaFT_2(27467)),':','Linewidth',1.5)
plot(Pi(1:end-20),Strain(1:end-20),'-','Linewidth',1.7,'Color',[0.1 0.7 0.7])
plot(Pi(1:end-20),Strain(1:end-20),'-','Linewidth',1.7,'Color',[0.1 0.8 0.5])
plot(Pi(1:end-20),Strain(1:end-20),'-','Linewidth',1.7,'Color',[0.1 0.2 0.7])
...
grid on 
set(gca,'GridColor',[0.1 0.2 0.9]) % a bluish color 
print(gcf,'CavatappiArtificialMuscle_LOADING(E2).png','-dpng','-r700');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%                    TEMPORAL PLOT                                %%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% p_temporal = (Pressure_3(21605:33799)-Pressure_3(21605))/145.038;
% po = 0; %Mpa
% P = 1.4;
% r = (2/2)/1000; %m
% ri = (0.85/2)/1000; %m
...
% Strain_model_temporal = (Z/78)*100;
% 
% fig=figure('units','inch','position',[0,0,3.5,2.5]); hold on; grid on; set(gca,'FontSize',8);
% 
% subplot(2,1,1);
% plot(time_3(21605:33799)-time_3(21605),p_temporal,':','LineWidth',1.5,'Color',[0,0,0]); 
% ylabel('Pressure, (MPa)')
% xlabel('Time (s)')
% 
%  ylim([-0.05 2.2])
% 
% subplot(2,1,2); 
% plot(time_3(21605:33799)-time_3(21605),-(Strain3(21605:33799)-Strain3(21605)),':','Linewidth',1.5,'Color',[0.5,0.5,0.5]); hold on
% plot(time_3(21605:33799)-time_3(21605),(Strain_model_temporal),'Linewidth',0.8,'Color',[0,0,0]);
% ylabel('Act. Strain, ɛ (%)')
% xlabel('Time (s)')
...
% 
% yyaxis right;
% H1 = plot(time_3(21605:33799)-time_3(21605),p_temporal,':','LineWidth',1,'Color',[0.5,0.5,0.5]); 
% ylabel('Pressure, (MPa)')
% set(gca,'ycolor',[0.5,0.5,0.5])
%  ylim([-0.05 2.2])
% yyaxis left;
% H2 =  plot(time_3(21605:33799)-time_3(21605),-(Strain3(21605:33799)-Strain3(21605)),'Linewidth',1,'Color',[0, 0, 0]);ylabel('Act. Strain')
% H3 =  plot(time_3(21605:33799)-time_3(21605),(Strain_model_temporal),'Linewidth',1,'Color',[1, 0, 1]);
% ylabel('Act. Strain')
% 
% set(gca,'ycolor',[0, 0, 0])
% xlabel('Time (s)')
