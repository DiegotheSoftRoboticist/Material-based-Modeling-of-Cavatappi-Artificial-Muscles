...
% ylim([0 60])
yyaxis left;
H2 =  plot(timeFT_1,-GammaFT_1,'Linewidth',1,'Color',[0, 0, 0]);% plot(time4003(1:(end)),p400_filt3(1:(end)),':','Linewidth',1.5)
...
plot(PressureFT_1MPa(16706-30:40:17500-30+1000)-PressureFT_1MPa(16706-30),(-GammaFT_1(16706:40:17500+1000)+GammaFT_1(16706)),'-','Linewidth',1,'Color',[0 0.4 0.9])
plot(PressureFT_2MPa(38974-20:40:40025-20+1000)-PressureFT_2MPa(38974-20),(-GammaFT_2(38974:40:40025+1000)+GammaFT_2(38974)),'-','Linewidth',1,'Color',[0.2 0.8 0.8])
plot(Pi(1:end),Gamma_z_theta_oi(1:end)-Gamma_z_theta_oi(1),':','Linewidth',2.3,'Color',[0,0,0])
% -Gamma_z_theta(1)
 xlim([0 1.5])
 ylim([-0.01 0.07])
% ;set(gca,'YTick',[0:10:40]); 
% legend('\gamma_{z\theta} Model \alpha = 40^\circ','\gamma_{z\theta} Experimental SAMPLE 1','\gamma_{z\theta} Experimental SAMPLE 2')
 xlabel('Pressure, (MPa)')
 ylabel('Shear strain, \gamma_{zθ}')

grid on 
set(gca,'GridColor',[0.1 0.2 0.9]) % a bluish color 
 print(gcf,'TorsionalCavatappi_42deg_FreeTorsion','-dpng','-r700');
...
% plot(p,GammExperimental,'-','Linewidth',1,'Color',[1,0.5,0.5])
% plot(PressureFT_1MPa(39075:40678),(-GammaFT_1(39075:40678)+GammaFT_1(39075)))
plot(PressureFT_1MPa(16706-30:40:17500-30)-PressureFT_1MPa(16706-30),(-GammaFT_1(16706:40:17500)+GammaFT_1(16706)),'-','Linewidth',1,'Color',[0 0.4 0.9])
plot(PressureFT_2MPa(38974-20:40:40025-20)-PressureFT_2MPa(38974-20),(-GammaFT_2(38974:40:40025)+GammaFT_2(38974)),'-','Linewidth',1,'Color',[0.2 0.8 0.8])
plot(Pi(1:end),Gamma_z_theta_oi(1:end)-Gamma_z_theta_oi(1),':','Linewidth',2.3,'Color',[0,0,0])
% -Gamma_z_theta(1)
 xlim([0 1.5])
 ylim([-0.01 0.07])
...
grid on 
set(gca,'GridColor',[0.1 0.2 0.9]) % a bluish color 
 print(gcf,'TorsionalCavatappi_42deg_FreeTorsionLOADING','-dpng','-r700');
 
 
 
%  grid on 
% set(gca,'GridColor',[0.1 0.2 0.9]) % a bluish color 
%  print(gcf,'stress distribution.png','-dpng','-r700');
