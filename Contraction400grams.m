...
% Retrieve Data Sample 1
    filename = '400grams Sample 1 Test 1.xlsx';
    sheet = 'Sheet1';
...
% Retrieve Data Sample 2
    filename = '400grams Sample 2 Test 1.xlsx';
    sheet = 'Sheet1';
...
% Retrieve Data Sample 3
    filename = '400grams Sample 3 Test 1.xlsx';
    sheet = 'Sheet1';
...
yyaxis right;
H1 = plot(time_2,Pressure_2,':','LineWidth',1,'Color',[0.5,0.5,0.5]); 
ylabel('Pressure, (MPa)')
set(gca,'ycolor',[0.5,0.5,0.5])
% ylim([0 60])
yyaxis left;
H2 =  plot(time_2,Strain2-Strain2(1),'Linewidth',1,'Color',[0, 0, 0]);ylabel('Act. Strain')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
F = 4 %N
Pi = [0:0.01:1.7]; %MPa which is equal to 200 psi\
P0 = 0; %Mpa
...
% plot((Pressure_1(12002-60:50:14713-60)-Pressure_1(12002-60))/145.038,-(Strain1(12002:50:14713)-Strain1(12002)),'Linewidth',1,'Color',[0.5,0.5,0.5])
plot((Pressure_2(21782-50:50:26750-50)-Pressure_2(21782-50))/145.038,-(Strain2(21782:50:26750)-Strain2(21782)),'-','Linewidth',1,'Color',[0 0.4 0.9])
plot((Pressure_3(30605-30:50:34428-30)-Pressure_3(30605-30))/145.038,-(Strain3(30605:50:34428)-Strain3(30605)),'-','Linewidth',1,'Color',[0.2 0.8 0.8])
...
grid on 
set(gca,'GridColor',[0.1 0.2 0.9]) % a bluish color 
print(gcf,'CavatappiArtificialMuscle_400grams.png','-dpng','-r700');   

fig1=figure('units','inch','position',[0,0,3.6,2.9]); hold on; grid on; set(gca,'FontSize',10);
% plot((Pressure_1(12002-60:50:14713-60)-Pressure_1(12002-60))/145.038,-(Strain1(12002:50:14713)-Strain1(12002)),'Linewidth',1,'Color',[0.5,0.5,0.5])
plot((Pressure_2(21782-50:50:26750-50-2500)-Pressure_2(21782-50))/145.038,-(Strain2(21782:50:26750-2500)-Strain2(21782)),'-','Linewidth',1,'Color',[0 0.4 0.9])
plot((Pressure_3(30605-30:50:34428-30-1500)-Pressure_3(30605-30))/145.038,-(Strain3(30605:50:34428-1500)-Strain3(30605)),'-','Linewidth',1,'Color',[0.2 0.8 0.8])
plot(Pi(1:end),Strain(1:end),':','Linewidth',2.3,'Color',[0,0,0])
...
grid on 
set(gca,'GridColor',[0.1 0.2 0.9]) % a bluish color 
print(gcf,'CavatappiArtificialMuscle_400gramsLOADING.png','-dpng','-r700');  
...
% %%%%%%%%%%%%%%%%%%%%%%%%                    TEMPORAL PLOT                                %%%%%%%%%%%%%%
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% p_temporal = (Pressure_3(23400:36900)-Pressure_3(23400))/145.038;
% po = 0; %Mpa
% P = 1.4;
% r = (2/2)/1000; %m
% ri = (0.85/2)/1000; %m
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% n_c = 24; %# of inserted coils
% D_mean = 2.85;
% Z = n_c*D_mean*pi*Gamma_z_theta_temporal
% Strain_model_temporal = (Z/148.1)*100;
% 
% 
% 
% fig=figure('units','inch','position',[0,0,3.5,2.5]); hold on; grid on; set(gca,'FontSize',8);
% 
% subplot(2,1,1);
% plot(time_3(23400:36900)-time_3(23400),p_temporal,':','LineWidth',1.5,'Color',[0,0,0]); 
% ylabel('Pressure, (MPa)')
% xlabel('Time (s)')
% 
%  ylim([-0.05 2.2])
...
% 
% subplot(2,1,2); 
% plot(time_3(23400:36900)-time_3(23400),-(Strain3(23400:36900)-Strain3(23400)),':','Linewidth',1.5,'Color',[0.5,0.5,0.5]); hold on
% plot(time_3(23400:36900)-time_3(23400),(Strain_model_temporal),'Linewidth',0.8,'Color',[0,0,0]);
% ylabel('Act. Strain, ɛ (%)')
% xlabel('Time (s)')
...
% 
% yyaxis right;
% H1 = plot(time_3(23400:36900)-time_3(23400),p_temporal,':','LineWidth',1,'Color',[0.5,0.5,0.5]); 
% ylabel('Pressure, (MPa)')
% set(gca,'ycolor',[0.5,0.5,0.5])
%  ylim([-0.05 2.2])
% yyaxis left;
% H2 =  plot(time_3(23400:36900)-time_3(23400),-(Strain3(23400:36900)-Strain3(23400)),'Linewidth',1,'Color',[0, 0, 0]);ylabel('Act. Strain')
% H3 =  plot(time_3(23400:36900)-time_3(23400),(Strain_model_temporal),'Linewidth',1,'Color',[1, 0, 1]);
% ylabel('Act. Strain')
% 
% set(gca,'ycolor',[0, 0, 0])
% xlabel('Time (s)')
