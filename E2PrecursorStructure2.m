...
%   plot(StrainE2_3(1004:1175)-StrainE2_3(1004), StressE2_3(1004:1175)-StressE2_3(1004),'Color',[0.5 0 1],'Linewidth',1)    
  plot(StrainE2_4(1135:1225)-StrainE2_4(1135), StressE2_4(1135:1225)-StressE2_4(1135),'Color',[0 0 0],'Linewidth',1)      
  plot(StrainE2_5(1135:1224)-StrainE2_5(1135), StressE2_5(1135:1224)-StressE2_5(1135),'Color',[0.1 0.5 0],'Linewidth',1)      
  plot(StrainE2_6(1135:1223)-StrainE2_6(1135), StressE2_6(1135:1223)-StressE2_6(1135),'Color',[0.5 0 0],'Linewidth',1)      
...
% 
%STATISTIC PLOT
StrainE2_4_Stat = StrainE2_4(1135:1225)-StrainE2_4(1135);
StressE2_4_Stat = StressE2_4(1135:1225)-StressE2_4(1135);
StrainE2_5_Stat = StrainE2_5(1135:1224)-StrainE2_5(1135);
StressE2_5_Stat = StressE2_5(1135:1224)-StressE2_5(1135);
StrainE2_6_Stat = StrainE2_6(1135:1223)-StrainE2_6(1135);
StressE2_6_Stat = StressE2_6(1135:1223)-StressE2_6(1135);
...
figure 
plot(StrainE2_Stat,StressE2_4_New); hold on;
plot(StrainE2_Stat,StressE2_5_New); hold on;
plot(StrainE2_Stat,StressE2_6_New)
...
fig=figure('units','inch','position',[0,0,4.75,3.5]); hold on; grid on; set(gca,'FontSize',8);
 
plot(StrainE2_Stat(1:11),Stress_mean(1:11),'LineWidth',0.7,'Color',[0,0,0]);
...
plot(StrainE2_Stat(1:11),-4.5*StrainE2_Stat(1:11),'LineWidth',0.4,'Color',[0.8,0,0]);
 ...
 a = errorbar(StrainE2_Stat,Stress_mean,yCI95(2,:),'o','MarkerSize',3,...
    'MarkerEdgeColor','black',...
    'MarkerFaceColor',[0.27,0.67,0.6],'LineWidth',0.6,'Color',[0.27,0.67,0.6])

%   ylim([-0.5 0.1]); %set(gca,'YTick',[0:0.5:2.1]);
% % 
...
xlabel('Strain, ɛ_2 (mm/mm)')
 
grid on 
set(gca,'GridColor',[0.1 0.2 0.9]) % a bluish color
print(gcf,'E2.png','-dpng','-r700');   
